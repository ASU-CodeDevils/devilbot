...
use crate::slack::conversation_replies::get_conversation_replies;
...
pub async fn handle_message_event(body: &Value) {
    ...
    let replies = get_conversation_replies(channel, event_thread_timestamp)
        .await
    ...
    if channel == intros_channel_id
        ...
        && !bot_replies_exist
    {
        commands::introduction_reply::reply_to_introduction(
